...
def productview(request, myid):
    ...
    products = product.objects.filter(product_id=myid)
...
def checkout(request):
    if request.method == "POST":
        ...
        # request paytm to transfer money to your account after payment by user
        param_dict = {
            'MID': 'VZdfSr17024461411511',
